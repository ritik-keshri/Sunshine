...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        if (sharedPreferences.getString(context.getString(R.string.pref_units_key),context.getString(R.string.pref_location_default)).equals(context.getString(R.string.pref_units_label_metric)))
            return true;
        else
            return false;
    }
